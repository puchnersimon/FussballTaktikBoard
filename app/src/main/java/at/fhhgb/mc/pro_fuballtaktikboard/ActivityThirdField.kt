...
class ActivityThirdField : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            GlobalScope.launch {
                ...
                runBlocking {
                    ...
                    if (!project.pathFreeArea.isNullOrEmpty()) {
                        //Output stream
                        ...
                        applicationContext?.contentResolver?.also { resolver ->
                            ...
                            val imageUri: Uri = Uri.parse(project.pathFreeArea)
                    ...
                    fragment = DrawFragment(projectViewModel, project, THIRD_FIELD, bitmap)
        ...
        binding.buttonBackToSecondField.setOnClickListener {
            ...
            intentBackToSecondField.putExtra("PROJECT_ID", project.id)
    ...
    private fun saveMediaToStorage() {
        ...
        val filename = "${project.projectName + "_" + THIRD_FIELD}.jpg"
